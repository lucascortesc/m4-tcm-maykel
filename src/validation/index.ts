...
export const familySchema = object()
  .shape({
    ...
    address_id: string().required(
      "Address_id is required on body request"
    ),
  })
  .noUnknown(true);
...
export const pacientSchema = object()
  .shape({
    ...
    last_name: string().required(
      "Last_name is required on body request"
    ),
    ...
    family_id: string().required(
      "Family_id is required on body request"
    ),
  })
  .noUnknown(true);
...
export const visitsSchema = object()
  .shape({
    ...
    message: string()
      .required("Message is required on body request")
